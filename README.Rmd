...
#version = content(GET("https://api.github.com/repos/piccolbo/dplyr.spark.hive/releases"))[[1]]$tag
```
...
cat(
  paste0('devtools::install_github("piccolbo/dplyr.spark.hive', version, '", subdir = "pkg")
'))
```
...
cat(
  ...
  "https://github.com/piccolbo/dplyr.spark.hive/releases/download/', version, '/dplyr.spark.hive_', version, '.tar.gz")
'))
```
